...
void happy() { printf("^_____^\n\n"); }

void sad() { printf("T_____T\n\n"); }

void fine() { printf("0_____0\n\n"); }

void bad() { printf("-_____-\n\n"); }
...
void _write(int idx) {
  ...
  note[idx] = calloc(1, sizeof(struct page));
  note[idx]->script = calloc(strlen(tmp), sizeof(char));
