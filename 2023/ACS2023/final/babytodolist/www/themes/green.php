  ...
  <section class="bg-[url('/images/bg-green.jpg')] h-screen x-screen bg-cover bg-no-repeat">
                ...
                <div class="flex space-x-4">
                  <div class="row">
                    ...
                    <a href="#" onclick="changeTheme('green');return false;">
                      <svg class="my-2 text-green-600 hover:text-green-700 focus:text-green-700" xmlns="http://www.w3.org/2000/svg" width="30" class="mr-2" fill="currentColor" viewBox="0 0 1792 1792">
                        <path d="M1728 647q0 22-26 48l-363 354 86 500q1 7 1 20 0 21-10.5 35.5t-30.5 14.5q-19 0-40-12l-449-236-449 236q-22 12-40 12-21 0-31.5-14.5t-10.5-35.5q0-6 2-20l86-500-364-354q-25-27-25-48 0-37 56-46l502-73 225-455q19-41 49-41t49 41l225 455 502 73q56 9 56 46z">
                        </path>
                      </svg>
                    </a>
                    <a href="#" onclick="changeTheme('blue');return false;">
                      <svg class="my-2 text-blue-100 hover:text-blue-700 focus:text-blue-700" xmlns="http://www.w3.org/2000/svg" width="30" class="mr-2" fill="currentColor" viewBox="0 0 1792 1792">
                        <path d="M1728 647q0 22-26 48l-363 354 86 500q1 7 1 20 0 21-10.5 35.5t-30.5 14.5q-19 0-40-12l-449-236-449 236q-22 12-40 12-21 0-31.5-14.5t-10.5-35.5q0-6 2-20l86-500-364-354q-25-27-25-48 0-37 56-46l502-73 225-455q19-41 49-41t49 41l225 455 502 73q56 9 56 46z">
                        </path>
                      </svg>
                    </a>
                    <a href="/logout.php">
                      <svg class="my-4 text-green-600" xmlns="http://www.w3.org/2000/svg" width="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                    </a>
                  </div>
                  ...
                  <div class="basis-1/2 w-full">
                    <div class="w-full border rounded-lg p-2">
                        ...
                        <div class="p-2">
                          ...
                          <?php foreach ($todos_row as $todo): ?>
                            <div class="Todo relative flex items-center border rounded p-2 mb-4">
                                <label for="default-checkbox" class="cursor-pointer text-sm font-medium text-gray-900 dark:text-gray-300">
                                  <input type="checkbox" onchange="todoDone('<?php echo $todo['id']; ?>')" value="" <?php if ($todo['done'] == 1): ?>checked="true"<?php endif; ?> class="cursor-pointer align-[-3px] w-4 h-4 mr-2 text-green-600 bg-gray-100 border-gray-300 rounded focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                          ...
                          <button type="button" onclick="showTodo()" class="mt-4 w-full text-white bg-green-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Add</button>
                        </div>
        ...
        <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
          <form id="addForm">
                  ...
                  <div class="mt-2">
                      <div id="addTodoList" class="justify-between items-center rounded py-2">
                          <div class="w-full my-2">
                            <input type="text" name="addText" id="addText" value="" class="p-1.5 w-full border text-sm font-medium text-gray-900 dark:text-gray-300 border-gray-300 rounded focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" placeholder="Write todo ...">
                          </div>
                      </div>
                  </div>
                </div>
            ...
            <div class="bg-gray-50 px-4 py-3 justify-center texgt-center sm:flex sm:flex-row-reverse sm:px-6">
              <button type="button" onclick="addTodo()" class="inline-flex w-full justify-center rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 sm:ml-3 sm:w-auto">Add</button>
  ...
  <div id="newTodo" class="Todo hidden relative flex items-center border rounded p-2 mb-4">
      <label for="default-checkbox" class="cursor-pointer text-sm font-medium text-gray-900 dark:text-gray-300">
        <input type="checkbox" value="" class="cursor-pointer align-[-3px] w-4 h-4 mr-2 text-green-600 bg-gray-100 border-gray-300 rounded focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
