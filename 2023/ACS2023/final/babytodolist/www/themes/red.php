  ...
  <section class="bg-[url('/images/bg-red.jpg')] h-screen x-screen bg-cover bg-no-repeat">
                ...
                <div class="flex space-x-4">
                  <div class="row">
                    <a href="#" onclick="changeTheme('red');return false;">
                      <svg class="my-2 text-red-600 hover:text-red-700 focus:text-red-700" xmlns="http://www.w3.org/2000/svg" width="30" class="mr-2" fill="currentColor" viewBox="0 0 1792 1792">
                  ...
                  <div class="basis-1/2 w-full">
                    <div class="w-full border rounded-lg p-2">
                        ...
                        <div class="p-2">
                          ...
                          <button type="button" onclick="showTodo()" class="mt-4 w-full text-white bg-red-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Add</button>
                        </div>
        ...
        <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
          <form id="addForm">
                  ...
                  <div class="mt-2">
                      <div id="addTodoList" class="justify-between items-center rounded py-2">
                          <div class="w-full my-2">
                            <input type="text" name="addText" id="addText" value="" class="p-1.5 w-full border text-sm font-medium text-gray-900 dark:text-gray-300 border-gray-300 rounded focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" placeholder="Write todo ...">
                          </div>
                      </div>
                  </div>
                </div>
            ...
            <div class="bg-gray-50 px-4 py-3 justify-center texgt-center sm:flex sm:flex-row-reverse sm:px-6">
              <button type="button" onclick="addTodo()" class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">Add</button>
  ...
  <div id="newTodo" class="Todo hidden relative flex items-center border rounded p-2 mb-4">
      <label for="default-checkbox" class="cursor-pointer text-sm font-medium text-gray-900 dark:text-gray-300">
        <input type="checkbox" value="" class="cursor-pointer align-[-3px] w-4 h-4 mr-2 text-red-600 bg-gray-100 border-gray-300 rounded focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
